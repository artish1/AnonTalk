  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-14 relative">
      <div className="w-full max-w-[400px] sm:max-w-[500px] md:max-w-[600px] absolute top-[40%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
        <h1 className="font-bold text-2xl text-slate-900 w-full text-left pb-8">
          Ask a Question
        </h1>
        <input
          className="bg-transparent disabled:opacity-50 border-b border-zinc-700 outline-none py-4 pr-4 w-full placeholder:text-slate-600 text-xl"
          value={text}
        ...
        <button
          ...
          className="mt-8 p-8 select-none disabled:opacity-70 disabled:cursor-not-allowed text-center w-full rounded bg-slate-950 text-[#edf7f6] text-lg hover:bg-black transition-all"
        >
